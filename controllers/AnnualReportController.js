...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const dir = 'uploads/annualreport';
...
exports.addAnnualReport = (req, res) => {
...
exports.getActiveAnnualReports = async (req, res) => {
  try {
    const reports = await AnnualReport.findAll({
...
exports.toggleAnnualReportDelete = async (req, res) => {
  try {
    const { id } = req.params;
    const report = await AnnualReport.findByPk(id);

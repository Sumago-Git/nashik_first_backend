...
const {
  trainingTypeWiseCount,
    ...
    getInstituteNCategoryList,
    trainerWiseSessionsConducted,
    schoolWiseSessionsConducted,
    yearWiseFinalSessionCount
...
router.post('/getInstitudeNCategoryList',authenticateToken, (req, res, next) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return apiResponse.validationErrorWithData(res, 'Validation Error', errors.array());
  }
...
router.post('/trainerWiseSessionsConducted',authenticateToken, (req, res, next) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return apiResponse.validationErrorWithData(res, 'Validation Error', errors.array());
  }
...
router.post('/schoolWiseSessionsConducted',authenticateToken, (req, res, next) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return apiResponse.validationErrorWithData(res, 'Validation Error', errors.array());
  }
...
router.post('/yearWiseFinalSessionCount',authenticateToken, (req, res, next) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return apiResponse.validationErrorWithData(res, 'Validation Error', errors.array());
  }
